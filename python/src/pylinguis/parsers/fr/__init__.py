...
class FRParser(ANTLRParserBase):
    """ A parser for French Linguis code. """

    def __init__(self) -> None:
        self.logger = logging.getLogger("parsers.fr")
        self.logger.info("FRParser::__init__")
